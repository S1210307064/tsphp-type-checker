...
import ch.tutteli.tsphp.typechecker.test.testutils.DefinitionErrorStruct;
...
public class VariableDefinitionErrorTest extends ATypeCheckerReferenceErrorTest
{
    ...
    public VariableDefinitionErrorTest(String testString, DefinitionErrorStruct expectedLinesAndPositions) {
    ...
    public static Collection<Object[]> testStrings() {
        ...
        collection.addAll(Arrays.asList(new Object[][]{
                    {"namespace{\n int $a=1;} namespace{\n int $a=1;}", new DefinitionErrorStruct(2, 5, 3, 5)},
                    {"namespace a {\n int $a=1;} namespace a{\n int $a=1;}", new DefinitionErrorStruct(2, 5, 3, 5)}
                }));
        return collection;
    }
    ...
    public static Collection<Object[]> getVariations(String prefix, String appendix) {
        return Arrays.asList(new Object[][]{
                    {prefix + "\n int $a;\n int $a;" + appendix, new DefinitionErrorStruct(2, 5, 3, 5)},
                    {prefix + "\n int $a=1;\n int $a;" + appendix, new DefinitionErrorStruct(2, 5, 3, 5)},
                    {prefix + "\n int $a=1;\n int $a=1;" + appendix, new DefinitionErrorStruct(2, 5, 3, 5)},
                    {prefix + "\n int $a;\n int $a=1;" + appendix, new DefinitionErrorStruct(2, 5, 3, 5)}
                });
    }
}
