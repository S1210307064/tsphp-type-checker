...
public class ResolveStaticClassMemberTest extends AReferenceStaticScopeTest
{
    ...
    public static Collection<Object[]> testStrings() {
        return Arrays.asList(new Object[][]{
                    ...
                    },
                    {
                        ...
                        new ScopeTestStruct[]{
                            accessor("a", "\\a\\.\\a\\.", 0, 1, 0, 0),
                            variable("\\a\\.\\a\\.", 0, 1, 0, 1)
                        }
                    },
                    //absolute path
                    {
                    ...
                    },
                    {
                        ...
                        new ScopeTestStruct[]{
                            accessor("\\a\\b\\a", "\\a\\b\\.\\a\\b\\.", 1, 1, 0, 0),
                            variable("\\a\\b\\.\\a\\b\\.", 1, 1, 0, 1)
                        }
                    },
                    //relative
                    {
                    ...
                    //using an alias
                    {
                        ...
                        new ScopeTestStruct[]{
                            accessor("\\a\\a", "\\a\\.\\a\\.", 1, 1, 1, 0),
                            variable("\\a\\.\\a\\.", 1, 1, 1, 1)
                        }
                    },
                    {
                        "namespace a{class a{static public float $d;}} "
                    ...
                    },
                    {
                        ...
                        new ScopeTestStruct[]{
                            accessor("self", "\\a\\.\\a\\.", 1, 0, 4, 1, 4, 0, 0),
                            variable("\\a\\.\\a\\.", 1, 0, 4, 1, 4, 0, 1)
                        }
                    },
                    //parent
                    {
                    ...
                    },
                    {
                        ...
                        new ScopeTestStruct[]{
                            accessor("parent", "\\.\\.", 1, 0, 4, 0, 4, 0, 0),
                            functionDefault(1, 0, 4, 0, 4, 0, 1)
                        }
                    },
                    {
                        "namespace a{class a{static public float $d;} "
                        ...
                        new ScopeTestStruct[]{
                            accessor("parent", "\\a\\.\\a\\.", 1, 1, 4, 0, 4, 0, 0),
                            variable("\\a\\.\\a\\.", 1, 1, 4, 0, 4, 0, 1)
                        }
                    },
                    {
                        ...
                        new ScopeTestStruct[]{
                            accessor("parent", "\\a\\.\\a\\.", 1, 0, 4, 0, 4, 0, 0),
                            variable("\\a\\.\\a\\.", 1, 0, 4, 0, 4, 0, 1)
                        }
                    },
                    {
                        ...
                        + "class b extends a{ public function void foo(){parent::$d;}}}",
                        new ScopeTestStruct[]{
                            accessor("parent", "\\a\\.\\a\\.", 1, 1, 0, 4, 0, 4, 0, 0),
                            variable("\\a\\.\\a\\.",  1, 1, 0, 4, 0, 4, 0, 1)
                        }
                    },
                    {
