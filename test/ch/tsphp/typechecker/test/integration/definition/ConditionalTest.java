...
/*
 * This class is based on the class ConditionalTest from the TinsPHP project.
...
import ch.tsphp.typechecker.test.integration.testutils.TestConditionalScopeFactory;
...
public class ConditionalTest extends ADefinitionTest
{
    ...
    public TestNamespaceScopeFactory createTestScopeFactory(
            IScopeHelper theScopeHelper, ITypeCheckerErrorReporter theInferenceErrorReporter) {
    ...
    public static Collection<Object[]> testStrings() {
        ...
        String b = "\\b\\.\\b\\.";
        String ab = "\\a\\b\\.\\a\\b\\.";
        String foreach = "foreach([1] as mixed $v){$a=1;}";
