...
public class TernaryOperatorWithReferenceErrorTest extends ATypeCheckWithReferenceErrorTest
{

    public TernaryOperatorWithReferenceErrorTest(String testString) {
        super(testString);
    }
    ...
    public static Collection<Object[]> testStrings() {
        return Arrays.asList(new Object[][]{
                ...
                {"int $a = NOT_DEFINED_CONSTANT ? 1 : 2;"},
                {"int $a = true ? NOT_DEFINED_CONSTANT : 2;"},
                {"int $a = true ? 1 : NOT_DEFINED_CONSTANT;"},
                {"int $a = $notDefinedVariable ? 1 : 2;"},
                {"int $a = true ? $notDefinedVariable : 2;"},
                {"int $a = true ? 1 : $notDefinedVariable;"},
        });
    }
