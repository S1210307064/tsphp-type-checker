...
public class GlobalNamespaceTest extends ATest
{
    ...
    public void testResolveLengthLessThanNamespace() {
        ...
        ScalarTypeSymbol symbol = new ScalarTypeSymbol("int", (Set<ITypeSymbol>) null, TypeBool, Bool, "false");
    ...
    public void testResolveLengthEqualToNamespace() {
        ...
        ScalarTypeSymbol symbol = new ScalarTypeSymbol("float", (Set<ITypeSymbol>) null, TypeFloat, Float, "0.0");
        globalNamespace.define(symbol);
